...
export default function Registration() {
  ...
  const [hasErrorNickname, setHasErrorNickname] = useState("");
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input
            ...
            maxLength={56}
            minLength={3}
            onChange={(e) => setValue(e, "nickname")}
            style={{
              border: hasErrorNickname ? "1px solid red" : null,
            }}
            required
          />
        </div>
        ...
        {hasErrorRepeatPassword && (
          <span className="span-message">Пароли не совпадают</span>
        )}
