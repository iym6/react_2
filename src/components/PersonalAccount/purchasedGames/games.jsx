export const games = [
  {
    ...
    description: {
      short:
        "Весёлая карточная игра для любой компании. Соберите животных для своего зоопарка!",
    ...
    media: {
      ...
      gallery: ["/images/Black Sheep1.jpg", "/images/Black Sheep2.jpg"],
    },
  },
  {
    id: "bang",
    ...
    media: {
      ...
      gallery: ["/images/Bang2.jpg", "/images/Bang1.jpg", "/images/Bang3.jpg"],
    },
  },
  {
    id: "carcassone",
    ...
    media: {
      ...
      gallery: ["/images/Carcassonne2.jpg", "/images/Carcassonne1.jpeg"],
    },
  },
  {
    id: "machi_koro",
    ...
    description: {
      short:
        "Постройте свой город и станьте первым мэром, кто построил самый красивый город",
    ...
    media: {
      ...
      gallery: ["/images/Machi Koro3.webp", "/images/Machi Koro2.jpg"],
    },
  },
  {
    id: "monopoly",
    ...
    media: {
      ...
      gallery: ["/images/Monopoly1.jpg", "/images/Monopoly2.webp"],
    },
  },
  {
    id: "citadels",
    ...
    description: {
      short:
        "Стратегическая игра о строительстве города и выборе скрытых ролей.",
  ...
  },
  {
    ...
    description: {
      short:
        "Торгуйте с другими игроками и стройте дороги и города, чтобы первым набрать очки.",
